...
{{
  ...
  "platform": [
    {{"name": "公司或主题名称", "news": "发生了什么，100-170个中文字，交代公司/事件/变化", "why_this_matters": "为什么值得关注，100-170个中文字，提炼背后的能力或模式变化", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
  "ai": [
    {{"title": "业务可理解的能力变化，不要写模型版本号", "capability": "AI 新增或增强了什么能力，100-160个中文字，用业务人员能理解的话说明", "industry_impact": "这种能力可能影响哪些行业流程，100-160个中文字，说明对搜索、客服、运营、内容、供应链等流程的影响", "trend": "2-4个普通人能理解的趋势关键词", "link": "原始文章链接"}}
  ],
  "sports": [
    {{"name": "公司或主题名称", "news": "发生了什么，100-170个中文字，交代公司/事件/变化", "why_this_matters": "为什么值得关注，100-170个中文字，提炼背后的能力或模式变化", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
  "retail": [
    {{"name": "公司或场景名称", "news": "用2-3句话完整说明企业、场景、具体动作和解决的问题，120-190个中文字", "why_this_matters": "提炼背后的零售模式或能力变化，100-160个中文字", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
