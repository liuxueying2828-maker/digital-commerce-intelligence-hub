...
{{
  ...
  "platform": [
    {{"name": "公司或主题名称", "news": "发生了什么，80-120个中文字，交代公司/事件/变化", "why_this_matters": "为什么值得关注，80-120个中文字，提炼背后的能力或模式变化", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
  "ai": [
    {{"title": "业务可理解的能力变化，不要写模型版本号", "capability": "AI 新增或增强了什么能力，80-110个中文字，用业务人员能理解的话说明", "industry_impact": "这种能力可能影响哪些行业流程，80-110个中文字，说明对搜索、客服、运营、内容、供应链等流程的影响", "trend": "2-4个普通人能理解的趋势关键词", "link": "原始文章链接"}}
  ],
  "sports": [
    {{"name": "公司或主题名称", "news": "发生了什么，80-120个中文字，交代公司/事件/变化", "why_this_matters": "为什么值得关注，80-120个中文字，提炼背后的能力或模式变化", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
  "retail": [
    {{"name": "公司或场景名称", "news": "用2-3句话完整说明企业、场景、具体动作和解决的问题，100-140个中文字", "why_this_matters": "提炼背后的零售模式或能力变化，80-110个中文字", "trend": "2-4个关键词", "link": "原始文章链接"}}
  ],
  "one_thing_worth_watching": "当天最值得持续观察的一条趋势，不要写成行动建议"
}}

数量要求：
- platform: 最多 5 条；人工输入质量高时优先人工输入，但必须有真实来源或明确人工输入内容支撑；每条 news 和 why_this_matters 各控制在 80-120 个中文字。
- ai: 最多 5 条；每条整体控制在 150-220 个中文字，重点是 Capability 与 Industry Impact；纯模型版本、参数或 Benchmark 新闻必须过滤。
- sports: 最多 5 条；可以使用行业报告、财报、门店扩张、消费趋势、产品体验变化等近 14 天内可靠信息；每条 news 和 why_this_matters 各控制在 80-120 个中文字。
- retail: 最多 5 条；每条整体控制在 150-220 个中文字，News 必须足够完整；严禁 Retail Media。
